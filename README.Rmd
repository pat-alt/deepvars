...
**NOTE** ℹ️: This is the repository for the companion package to our paper @altmeyer2021deep. For the specific code used for the paper and additional resources please see [this repository](https://github.com/pat-alt/deepvarsMacro).
